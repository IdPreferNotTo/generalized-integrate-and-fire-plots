...
if __name__ == "__main__":
    ...
    ax1.plot(t, a, lw=1, c=st.colors[2])
    ax1.set_xlabel("$t$ [ms]")
    ax1.set_xlim([0, 110])
    ax1.set_xticklabels([])
    ax1.set_ylabel("$z$")
    ...
    # inset axes....
    axins = ax1.inset_axes([0.025, 0.4, 0.4, 0.6])
    axins.plot(t, a, lw=1, c=st.colors[2])
    ...
    ax2.plot(t, v, lw=1, c=st.colors[0])
    ...
    ax3.plot(v_det_plot, a_det_plot, c="k", zorder=3)
    v_plot = v[850000:910000]
    a_plot = a[850000:910000]
    ax3.plot(v_plot, a_plot, c="C0")
    ax3.set_xlabel("$V$ [mV]")
    ax3.set_ylabel("$z$")

    plt.savefig(home + "/Desktop/Presentations/SCC SfB/fig6.png", dpi=300)
    plt.show()
