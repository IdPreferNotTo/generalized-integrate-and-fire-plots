...
def plt_mean_t_qif(tau_n, D):
    ...
    for k in range(25):
        ...
        data_file = home + "/Data/LIF/data/mu{:.2f}_tau_a{:.1f}_tau_n{:.2f}_D{:.5e}_Delta{:.1f}_ratio{:.2f}.txt".format(
    ...
    ax.legend()
    #plt.savefig(home + "/Data/LIF/white/plots/spike_time_derivation_taun{:.1f}_D{:.1f}.pdf".format(tau_n, D))
    plt.show()
    return 1
