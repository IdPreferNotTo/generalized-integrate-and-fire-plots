...
if __name__ == "__main__":
    ...
    ax2.scatter(ks, k_correlatins_adap, ec="C0", s=20, fc="w", linewidths=1, zorder=5)
    ax2.scatter(ks, k_correlatins_cnoise, ec="C1", s=20, fc="w", linewidths=1, zorder=5)
    ...
    plt.savefig(home + "/Data/Plots/fig11.pdf", transparent=True)
    plt.show()
